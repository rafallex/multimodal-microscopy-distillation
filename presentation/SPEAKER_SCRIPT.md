...
"One finding I want to highlight, because it surprised me: ensembling **never** worked here. My three-seed average scored *below* my best single seed. Cross-recipe averages regressed. Even a genuinely decorrelated gradient-boosted model — the textbook ideal ensemble ingredient — dragged me down, because its cross-validation didn't transfer. With twelve patients, variance dominates, and any averaging regresses below the best single draw. So my submission is one well-chosen model — never a blend."
